    ...
    <div className="min-h-screen bg-gray-900 flex flex-col">
      ...
      <div className="fixed top-0 left-0 w-full bg-gray-800 text-gray-100 p-2 flex justify-between items-center z-50">
        <div className="flex items-center">
            ...
            <div className="flex items-end space-x-[1px]">
              {staticBars.map((height, index) => (
                <div
                  ...
                  style={{ 
                    height: `${isMounted ? miniBars[index] : height}rem` 
                  }}
                />
              ))}
            </div>
          ...
          {/* Mensagem de boas-vindas personalizada para alunos */}
          {!isAdmin && currentUser && (
            <span className="ml-10 text-orange-400 font-semibold text-2xl">Bem vindo {currentUser}</span>
          )}
        </div>
        ...
        {/* Botão de Painel de Administração centralizado */}
      ...
      {/* Cabeçalho */}
      <div className="mt-12 pt-8 pb-4 flex flex-col items-center">
        <Equalizer />
      </div>
